  ...
  <div class="col-sm">
    ...
    <table class="table">
      ...
      <tbody>
        ...
        ?>
          <tr>
            <th scope="row"><?php echo $team->getName(); ?></th>
            <td><?php echo $team->getP1(); ?></td>
            <td><?php echo $team->getP2(); ?></td>
            <td> <a href=<?php echo "./teams/delete?id_team={$team->getId()}"; ?>>Excluir</a></td>
          </tr>
        <?php
        }
        ?>
